...
def grid_search():
    ...
    categories = ['animal', 'body', 'cremat', 'currency', 'dismed', 'email_address', 'event', 'food', 'instru', 'lang',
                  'letter', 'other', 'plant', 'product', 'religion', 'sport', 'substance', 'symbol', 'techmeth',
                  'termeq', 'veh', 'weahter', 'word']

    train = load_files('fine/ENTY',  categories=categories,  shuffle=True,  random_state=42)
...
def build_model():
    ...
    filehandler = open('fine-enty-classifier.p', 'wb')
